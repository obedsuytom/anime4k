...
async def top_rated_menu(call: types.CallbackQuery):
    ...
    for anime, score in rows:
        ...
        text = f"{score} <tg-emoji emoji-id=\"5438496463044752972\">👍</tg-emoji> — {anime_title}"
    ...
    # Кнопка назад
    buttons.append([InlineKeyboardButton(text="Назад", callback_data="overview_menu", style="success")])
