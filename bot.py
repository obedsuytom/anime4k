...
# Inline хендлер с подгрузкой страниц
@dp.inline_handler()
async def inline_search(query: types.InlineQuery):
    ...
    # Считаем, есть ли следующая страница
