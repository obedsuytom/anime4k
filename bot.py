...
# Функция для обрезки текста кнопки, чтобы не выпирало
    def short_btn(text, max_len=15):
...
# Добавляем навигацию в один ряд (если есть)
    if nav_buttons:
        kb.row(*nav_buttons)
...
# Кнопка для скачивания из облака, если нужно
